...
const LOAD_CUSTOM_PLOTS = `${COMPONENT_CONFIG}/loadCustomPlots`;
const TRAJECTORY_NODES_SELECTION_UPDATED = `${COMPONENT_CONFIG}/trajectoryNodesUpdated`;

export {
  LOAD_CONFIG, UPDATE_CONFIG, RESET_CONFIG, SAVE_CONFIG,
  PLOT_DATA_LOADED, PLOT_DATA_LOADING, PLOT_DATA_ERROR,
  TRAJECTORY_NODES_SELECTION_UPDATED, LOAD_CUSTOM_PLOTS,
};
